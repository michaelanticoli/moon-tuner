              ...
              <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="flex flex-col md:flex-row gap-12 items-start mb-16">
                      ...
                      <div>
                        ...
                        <h1 className="text-[clamp(2.5rem,6vw,6rem)] font-serif leading-[0.9] tracking-tight mb-6">
                          The Moon <br />
                    ...
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                      <div className="space-y-8">
                        ...
                        {livePhase !== null && (
                          <motion.div 
                            initial={{ opacity: 0 }} 
                            animate={{ opacity: 1 }} 
                            className="p-6 bg-card border border-border rounded-2xl inline-block"
                          >
                      ...
                      <div className="p-12 bg-card border border-border rounded-[3rem] backdrop-blur-xl">
                        ...
                        <div className="space-y-8">
                          <div>
                            <label className="text-[9px] uppercase tracking-widest text-muted-foreground font-bold block mb-2">
                              Birth Date
                            </label>
                            <Input
                              type="date"
                              value={formData.date}
                              className="bg-transparent border-0 border-b border-border rounded-none py-4 focus-visible:ring-0 focus-visible:border-gold"
                          ...
                          <div className="grid grid-cols-2 gap-8">
                            ...
                            <div>
                              ...
                              <Input
                                ...
                                className="bg-transparent border-0 border-b border-border rounded-none py-4 focus-visible:ring-0 focus-visible:border-gold placeholder:text-muted-foreground/50"
                              />
                            </div>
                          </div>
                          <Button
                            onClick={handleCalculate}
                            className="w-full py-6 h-auto bg-foreground text-background font-bold text-[11px] uppercase tracking-[0.3em] rounded-full hover:bg-accent hover:text-accent-foreground transition-all duration-500"
                          >
                ...
                {step === 'generating' && (
                  <motion.div 
                    ...
                    animate={{ opacity: 1 }} 
                    exit={{ opacity: 0 }} 
                    className="text-center py-20 min-h-[50vh] flex flex-col items-center justify-center"
                  >
                    ...
                    <p className="text-muted-foreground text-[10px] uppercase tracking-[0.5em] animate-pulse">
                      Engaging Ephemeris Matrix
                    </p>
                  </motion.div>
                )}
                      ...
                      {report.arc.map((item, i) => (
                        ...
                        >
                          ...
                          <div className="flex justify-between items-start mb-8 relative z-10">
                            <div>
                              <span className="text-3xl font-serif text-foreground group-hover:text-gold transition-colors block">
                                {item.month}
                              </span>
                              <span className="text-sm text-muted-foreground">Day {item.day}</span>
                            </div>
                            <span className="text-[9px] text-accent font-bold tracking-widest border border-accent/20 px-2 py-1 rounded">
                              {item.intensity} Power
                            </span>
                          </div>
                          <h4 className="text-foreground font-bold tracking-widest uppercase text-xs mb-2">
                            {item.focus}
                          </h4>
